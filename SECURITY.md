...
| **Cross-site API abuse** | CORS restricted to the Pages origin (+ localhost), `allow_credentials=False`. (CORS is browser-only; the rate/daily caps handle direct `curl`.) |
